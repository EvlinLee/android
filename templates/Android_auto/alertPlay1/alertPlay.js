...
function getUrls(u) {
	...
	if ( stburl ) {
		...
		var api = 'http://192.168.1.111:8080/polymer/play/play.php?u='+encodeURIComponent(u)+'&r=http://192.168.1.111:8090/ott_main.html';
		r.push('http://192.168.1.111:8090/need/play/'+stbid+'/'+encodeURIComponent(api));
	}
